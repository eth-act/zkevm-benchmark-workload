...
Example:
    ...
    Output: PRECOMPILE_EC_PAIRING (120M gas, Prague)
...
class TestNameFormatter:
    ...
    def format_test_name(self, test_name: str) -> str:
        ...
        # Create display name
        display = DisplayName(
            opcodes=test_info.opcodes if test_info.opcodes else ["UNKNOWN"], parameters=parameters
        )
