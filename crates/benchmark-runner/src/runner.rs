...
use zkevm_metrics::{
    BenchmarkRun, CrashInfo, ExecutionMetrics, HardwareInfo, ProvingMetrics, VerificationMetrics,
};
...
pub fn run_verify_from_disk(
        ...
        })
    {
        ...
        let verification_result =
            panic::catch_unwind(panic::AssertUnwindSafe(|| ere_zkvm.verify(&proof)));
